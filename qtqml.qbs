...
import "headers/QtQmlHeaders.qbs" as ModuleHeaders

QtModuleProject {
    id: module
    condition: project.qml
    name: "QtQml"
    simpleName: "qml"
    ...
    QtModule {
        ...
        Transformer {
            condition: product.disassembler
            inputs: module.prefix + "/disassembler/udis86/optable.xml"
            Artifact {
            ...
            prepare: {
                var cmd = new Command("python", [
                    module.prefix + "/disassembler/udis86/itab.py",
                    input.filePath
                ]);
